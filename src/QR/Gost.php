...
class Gost implements \ArrayAccess
{
    ...
    public function __construct($name = null, $pacc = null, $bankname = null, $bic = null, $cacc = null)
    {
        ...
        if(null !== $pacc) $this->PersonalAcc = $pacc;
        if(null !== $bankname) $this->BankName = $bankname;
        if(null !== $bic) $this->BIC = $bic;
        if(null !== $cacc) $this->CorrespAcc = $cacc;
    }
